# Codebase Health & Physics Integrity Audit SOP

This checklist is used whenever the "Run Health Audit" command is given, or automatically before major pull requests.
