...
This document defines the Standard Operating Procedure (SOP) for the "Codebase Health & Physics Integrity Audit" for the Kazamidori Project.

Run this audit manually by requesting "Run Health Audit", or automatically prior to major pull requests.
