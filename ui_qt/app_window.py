...
QToolBox::tab:focus    { border-color: #ffffff; outline: none; }
...
QPushButton:focus    { border-color: #c5a5f7; outline: none; }
...
QPushButton#btn_run:focus  { border-color: #ffffff; outline: none; }
QPushButton#btn_stop { background: #f38ba8; color: #1e1e1e; border-color: #f38ba8; }
QPushButton#btn_stop:hover { background: #eba0ac; }
QPushButton#btn_stop:focus { border-color: #ffffff; outline: none; }
...
QPushButton#btn_phase1_run:focus { border-color: #ffffff; outline: none; }
...
QPushButton#btn_adv_settings:focus { border-color: #c5a5f7; outline: none; }
QToolBar {
...
QToolBar QToolButton:focus   { border-color: #c5a5f7; outline: none; }
