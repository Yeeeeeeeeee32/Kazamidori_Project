...
QToolBox::tab:focus    { border: 2px solid #c5a5f7; outline: none; }
...
QPushButton:focus    { border: 2px solid #7eb3ff; outline: none; }
...
QToolBar QToolButton:focus   { border: 2px solid #7eb3ff; outline: none; }
