...
QToolBox::tab:focus    { outline: none; border-color: #ffffff; }
...
QPushButton#btn_run:focus  { outline: none; border-color: #ffffff; }
QPushButton#btn_stop { background: #f38ba8; color: #1e1e1e; border-color: #f38ba8; }
QPushButton#btn_stop:hover { background: #eba0ac; }
QPushButton#btn_stop:focus { outline: none; border-color: #ffffff; }
...
QPushButton#btn_phase1_run:focus { outline: none; border-color: #ffffff; }
...
QPushButton#btn_adv_settings:focus { outline: none; border-color: #ffffff; }
QToolBar {
...
QToolBar QToolButton:focus   { outline: none; border-color: #ffffff; }
