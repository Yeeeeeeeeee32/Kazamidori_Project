...
QToolBox::tab:focus    { outline: none; border-color: #f9e2af; }
...
QPushButton:focus    { outline: none; border-color: #f9e2af; }
...
QToolBar QToolButton:focus   { outline: none; border-color: #f9e2af; }
